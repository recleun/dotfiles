...
complete -c pmgr -n "__fish_pmgr_needs_command" -f -a "info" -d 'Display the project\'s information'
...
complete -c pmgr -n "__fish_pmgr_using_subcommand info" -s h -l help -d 'Print help'
complete -c pmgr -n "__fish_pmgr_using_subcommand info" -s V -l version -d 'Print version'
...
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "read" -d 'Print the project\'s JSON data'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "list" -d 'List a group\'s data or active groups data'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "info" -d 'Display the project\'s information'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "check" -d 'Checks for a project in current and parent directories'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "init" -d 'Initialize a project in the current directory'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "set" -d 'Set project\'s information fields'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "create" -d 'Create a group in the current project'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "delete" -d 'Delete a group in the current project'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "watch" -d 'Watch a group or a list of groups'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "unwatch" -d 'Unwatch a group or a list of groups'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "add" -d 'Add some data to a group'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "remove" -d 'Remove some data from a group'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "task" -d 'Do some commands to tasks'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "shell-completions" -d 'Generate shell completions for pmgr'
complete -c pmgr -n "__fish_pmgr_using_subcommand help; and not __fish_seen_subcommand_from read list info check init set create delete watch unwatch add remove task shell-completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
